...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "Bookster@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "Bookster API";

        private String description = "Bookster API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "Bookster";
